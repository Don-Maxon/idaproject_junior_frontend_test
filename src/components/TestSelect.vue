<template>
        <div class="dropdown">
                ...
                <div class="dropdown_content" ref="dropdown_content">
                        <p 
...
export default {
        ...
        computed: {
                getUnchangedVal(){
                        return this.$props.options.filter((i) => i.value != this.$props.modelValue.value)
                }

        },
        methods:{
                changeActiveValue(val){
                        // console.log(this.$refs.dropdown_content.style);
                        // this.$refs.dropdown_content.style.display = "none";
                        // console.log(this.$refs.dropdown_content.style.display);
